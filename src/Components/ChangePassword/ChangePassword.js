...
const ChangePassword = (props) => {
    const { changePassword, setLoading } = props
    ...
    return (
        <div className="card card--form">
            <div className="card--body">
                <h1>STEM Unicorn</h1>
                <Formik
                    initialValues={{exist_password  : '' ,  password: '', confirm_password: '' }}
                    ...
                    onSubmit={async (values, { setSubmitting }) => {
                        ...
                        if  (!exist_password) {
                            ...
                            setLoading(true)
                            await changePassword(user_id, values)
                                .then(
                                    response => {
                        ...
                        <form className="form" onSubmit={handleSubmit}>
                            ...
                            <div className="form--item">
                                <Input
                                    ...
                                    onBlur={handleBlur}
                                    value={values.exist_password}
                                    placeholder="EXIST PASS" />
                            </div>
...
export default connect(null, { changePassword })(IsLoadingHOC(ChangePassword))
