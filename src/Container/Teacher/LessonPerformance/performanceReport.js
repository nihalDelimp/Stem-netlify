...
const StudentPerformanceReport = (props) => {
    ...
    const AverageGrade = (score) => {
        ...
        if (avg > 100000) {
            let gain = avg - 100000;
            let gainPercentage = ((gain * 100) / 100000).toFixed(1);
            return gainPercentage;
        }
        else {
            let loss = 100000 - avg;
            let lossPercentage = -((loss * 100) / 100000).toFixed(1);
...
export default IsLoadingHOC(IsloggedinHOC(StudentPerformanceReport));