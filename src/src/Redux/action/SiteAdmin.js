...
export const updateSchoolAction = (id , data ) => async () => {
    return new Promise( async ( resolve, reject ) => {
...
// ----- School Administartors Management System   ----- //
export const addNewSchoolAdmin = ( data ) => async () => {
    return new Promise( async ( resolve, reject ) => {
        await authAxios().post( '/school-dashboard/add-school-admin', data )
            .then(
                response => resolve( response.data ),
                error => reject( error )
            )
...
export const getSchoolAdminList = (data) => async () => {
    return new Promise( async ( resolve, reject ) => {
        await authAxios().post('/school-dashboard/get-all-school-admin' ,data)
            .then(
                response => resolve( response.data ),
                error => reject( error )
            )
...
export const deleteSchoolAdminAction = ( id ) => async () => {
    return new Promise( async ( resolve, reject ) => {
        await authAxios().delete( `/school-dashboard/delete-school-admin-details/${id}`)
            .then(
                response => resolve( response.data ),
                error => reject( error )
            )
...
export const getSchoolAdminDetail = (id) => async () => {
    return new Promise( async ( resolve, reject ) => {
        await authAxios().get( `/school-dashboard/get-school-admin-details/${id}` )
            .then(
                response => resolve( response.data ),
                error => reject( error )
            )
...
export const updateSchoolAdminAction = (id , data ) => async () => {
    return new Promise( async ( resolve, reject ) => {
        await authAxios().put( `/school-dashboard/edit-school-admin-details/${id}`, data )
            .then(
                response => resolve( response.data ),
                error => reject( error )
            )
